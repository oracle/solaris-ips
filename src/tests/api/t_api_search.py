...
class TestApiSearchBasics(pkg5unittest.SingleDepotTestCase):
    ...
    example_pkg10 = """
            ...
            add dir mode=0755 owner=root group=bin path=/usr/lib/python3.11/vendor-packages/OpenSSL
...
"""
    ...
    res_remote_openssl = set([
        ("pkg:/example_pkg@1.0-0", "basename", "dir group=bin mode=0755 owner=root path=usr/lib/python3.11/vendor-packages/OpenSSL")
    ])
